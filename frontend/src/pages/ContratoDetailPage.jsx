    ...
    <Layout>
      ...
      {eliminando && (
        <ConfirmDialog
          ...
          mensaje="¿Seguro que quieres eliminar este contrato? Se eliminarán también sus cargos y pagos asociados."
      ...
      {contrato.notas_internas && (
        <div className="bg-surface-container-lowest border border-border-subtle rounded-xl p-6 mb-10">
          <h3 className="font-title-lg text-title-lg mb-3 text-on-surface flex items-center gap-2">
            <span className="material-symbols-outlined text-[20px] text-status-warning">lock</span>
            Notas internas
          </h3>
          <p className="text-body-md text-text-main whitespace-pre-wrap">{contrato.notas_internas}</p>
          <p className="text-xs text-text-muted mt-3">Solo visible para el equipo, no se comparte con el cliente.</p>
        </div>
      )}
